 ...
 * @author Kevin Glass
 * 
 * 2011-04-06 Pier Janssen: fixed bug with bitmask in resolve method.
 */
	...
	public void resolve(BodyList bodyList, float dt) {
		for (int i = 0; i < bodyList.size(); ++i)
		{
			...
			for (int j = i+1; j < bodyList.size(); ++j)
			{
				...
				if ((bi.getBitmask() & bj.getBitmask()) == 0) { //2011-04-06 Pier Janssen : was !=, changed to ==. Matching bitmasks should collide, non-matching should not.
					continue;
				}
